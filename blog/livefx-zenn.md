...
このシステムは、去年と同様、滋慶学園グループの入学式を対象とし、18 の保護者を含めた専門学校グループ、最大 4,000 台の観客用スマートフォンへの同時配信を想定したスケーラブルな設計が求められました。
...
２人以上の Approved がないと本来はいけないんですが、`admin` 権限を使えば bypass できます。
